import sys
import tkinter
from windows_audio_core import windows_audio_core
from os import path
winvolume = windows_audio_core()
...
#winaudio = cast(AudioUtilities.GetSpeakers().Activate(IAudioEndpointVolume._iid_, CLSCTX_ALL, None), POINTER(IAudioEndpointVolume))
